		...
		if(data[i].children !== undefined && data[i].children.length > 0){
			...
			for(var j=0;j<data[i].children.length;j++){
				if(data[i].children[j].target === "_blank"){
					ulHtml += '<dd><a href="javascript:;" style="font-size: 20px" data-url="'+baseUrl+data[i].children[j].href+'" target="'+data[i].children[j].target+'">';
				}else{
					ulHtml += '<dd><a href="javascript:;" style="font-size: 20px" data-url="'+baseUrl+data[i].children[j].href+'">';
				}
			...
			if(data[i].target === "_blank"){
				ulHtml += '<a href="javascript:;" data-url="'+baseUrl +data[i].href+'" target="'+data[i].target+'">';
			}else{
				ulHtml += '<a href="javascript:;" data-url="'+baseUrl +data[i].href+'">';
			}
			if(data[i].icon !== undefined && data[i].icon !== ''){
				if(data[i].icon.indexOf("icon-") !== -1){
					ulHtml += '<i class="iconfont '+data[i].icon+'" style="font-size: 20px" data-icon="'+data[i].icon+'"></i>';

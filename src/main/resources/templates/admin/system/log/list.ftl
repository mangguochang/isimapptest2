    ...
    <form class="layui-form">
        <div class="layui-inline" style="margin-left: 15px">
            ...
            <div class="layui-input-inline">
                <input type="text" value="" name="s_title" class="layui-input search_input">
            </div>
        </div>
        <div class="layui-inline" style="margin-left: 15px">
            <label>访问人:</label>
            <div class="layui-input-inline">
                <input type="text" value="" name="s_username" class="layui-input search_input">
            </div>
        </div>
        <div class="layui-inline" style="margin-left: 15px">
            <label>访问时间:</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-form layui-input" name="s_createDate" id="s_createDate" readonly="readonly"/>
            </div>
        </div>
...
<script type="text/javascript" src="${base}/static/layui/laydate/laydate.js"></script>
    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'title',  title: '功能模块',width:'25%'},
                {field:'remoteAddr',     title: '访问IP',width:'15%'},
                {field:'username',       title: '访问人',width:'13%'},
                {field:'exception',    title: '异常信息',width:'15%'},
                {field:'createTime',  title: '访问时间',width:'12%',templet:'<div>{{ layui.laytpl.toDateString(d.createTime,"yyyy-MM-dd HH:mm") }}</div>',unresize: true}, //单元格内容水平居中
        ...
        table.on('tool(demo)', function(obj){
            var data = obj.data;
            if(obj.event === "del"){
                /*layer.confirm("你确定要删除该日志吗？",{btn:['确定','取消']},
                    function(){
        ...
        var active={
            deleteSome : function(){                        //批量删除
                ...
                if(data.length > 0){
                    layer.confirm("你确定要删除这些日志吗？",{btn:['确定','取消']},
                        function(){
                            var d = [];

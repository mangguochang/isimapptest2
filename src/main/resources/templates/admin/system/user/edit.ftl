...
<form class="layui-form" style="width:80%;margin: 0px auto;">
    ...
    <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="mobileNum" value="${user.mobileNum}" autocomplete="off"  lay-verify="required|phone">
            </div>
    </div>
    ...
    <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="email" value="${user.email}" autocomplete="off" lay-verify="required|email">
            </div>
    </div>
    ...
    <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="roleIdList"  xm-select="roleIdList" lay-verify="required" >
                    <option value=""></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="sort" value="${user.sort}" autocomplete="off" lay-verify="required|number">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block" style="text-align: center;">
            <button class="layui-btn" lay-submit="" lay-filter="updateUser" style="width: 100px;">确定</button>

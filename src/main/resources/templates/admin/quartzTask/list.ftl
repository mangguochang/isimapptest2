...
<script>
    layui.use(['layer','form','table','laydate'], function() {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该定时任务吗？",{btn:['确定','取消']},
                        function(){
            ...
            if(obj.event === "paush"){
                layer.confirm("你确定要暂停该定时任务吗？",{btn:['确定','取消']},
                        function(){
            ...
            if(obj.event === "resume"){
                layer.confirm("你确定要恢复该定时任务吗？",{btn:['确定','取消']},
                        function(){
            ...
            if(obj.event === "run"){
                layer.confirm("你确定要立即执行该定时任务吗？",{btn:['确定','取消']},
                        function(){
        ...
        var t = {
            ...
            cols: [[
                ...
                {field:'createTime',  title: '创建时间',width:'15%',templet:'<div>{{ layui.laytpl.toDateString(d.createTime,"yyyy-MM-dd HH:mm") }}</div>',unresize: true}, //单元格内容水平居中

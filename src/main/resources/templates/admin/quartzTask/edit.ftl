...
<form class="layui-form" style="width:80%;margin: 0px auto;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="status"  value="0" title="正常" <#if (quartzTask.status == 0)> checked="" </#if>>
            <input type="radio" name="status"  value="1" title="暂停" <#if (quartzTask.status == 1)> checked="" </#if>>
        </div>
        <div class="layui-input-block">
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="remarks"  placeholder="请输入" class="layui-textarea">${quartzTask.remarks}</textarea>
        </div>
    </div>
    <div class="layui-form-item">

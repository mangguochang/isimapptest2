...
<head>
    ...
    <link rel="icon" href="${base}/static/images/login/favicon_play.ico">
    <link rel="stylesheet" href="${base}/static/layui/css/layui.css" media="all" />
    <link rel="stylesheet" href="${base}/static/css/login.css?t=${.now?long}" media="all" />
</head>
<body>
<div id="bg-body">
    <img id="bg-body0" src="${base}/static/images/login/dong.jpg" alt="Full screen background image" style="display: inline-block;">
</div>
<div class="login">
    <h1>公共数据库及公共信息平台</h1>
...
<script>
    layui.use(['layer', 'form'], function() {
        ...
        $(document).ready(function() {
            <#--var srcBgArray = ["${base}/static/images/login/dong.jpg",-->
                <#--"${base}/static/images/login/login1.jpeg"];-->

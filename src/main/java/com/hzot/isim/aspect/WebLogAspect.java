...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.hzot.isim.annotation.SysLog)")
    public void webLog(){}
...
//        sysLog.setParams(str.length()>5000?JSONObject.toJSONString("请求参数数据过长不与显示"):str);
        ...
        if(MySysUser.CurrentUser() != null) {
            sysLog.setUsername(StringUtils.isNotBlank(MySysUser.realName()) ? MySysUser.realName() : MySysUser.loginName());
        }
    }

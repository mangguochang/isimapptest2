 ...
 * @ClassName: SafeProperties
 * @Description: TODO
 * @Author: lolipopjy
 * @Date: 2019-11-04 18:17
 *
 */
...
public class SafeProperties extends Properties {
    ...
    *@return:
    */
    public synchronized List<Object> replaceAll(Map<String,Object> map) {
        ...
        for(String key :map.keySet()){
            ...
            if(containsKey){
                ...
                context.putOrUpdate(key.toString(), value.toString());
                objectList.add(super.put(key, value));
            }
        }
        return objectList;
    }
    ...
    class PropertiesContext {
        ...
        public void putOrUpdateAll(Map<String,Object> map) {
            for(String key : map.keySet()){
                String value = String.valueOf(map.get(key));
                PropertyEntry pe = new PropertyEntry(key, value);
                int index = remove(key);
...
//        try {
//            File file = ResourceUtils.getFile("classpath:camelTemplate/db/application.properties");
//            FileInputStream inputStream = new FileInputStream(file);
//            p.load(inputStream);
//            p.setProperty("server.port","ddddd");
////                ByteArrayOutputStream baos = new ByteArrayOutputStream();
//            FileOutputStream fileOutputStream = null;
//            //向OutPutStream中写入，如 message.writeTo(baos);
//            fileOutputStream = new FileOutputStream("C:\\Users\\lolipopjy\\Desktop\\新建文件夹\\temp.properties");
//            p.store(fileOutputStream,null);
//            String str = fileOutputStream.toString();

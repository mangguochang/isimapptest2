package com.hzot.isim.util.quartz;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) {
        ...
        if(StringUtils.isNotBlank(param) && StringUtils.isNumeric(param)){
			log.setCreateId(param);
			log.setUpdateId(param);
		}else{
        	//定义死
			log.setCreateId( UUID.randomUUID().toString());
			log.setUpdateId( UUID.randomUUID().toString());
		}
